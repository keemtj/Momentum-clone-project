...
/*!*****************************!*\
  !*** ./src/js/animation.js ***!
  \*****************************/
/*! exports provided: fadeIn, fadeOut, movePage */
...
var movePage = function movePage(from, to) {
  ...
  setTimeout(function () {
    if (from.id === 'signup' && to.id === 'login') {
      ...
      _reset__WEBPACK_IMPORTED_MODULE_0__["resetHint"]();
    }
    ...
    _reset__WEBPACK_IMPORTED_MODULE_0__["resetPwCondition"]();
    _reset__WEBPACK_IMPORTED_MODULE_0__["resetMsg"]();
    _reset__WEBPACK_IMPORTED_MODULE_0__["resetErrorBg"]();
    fadeIn(to, 300);
  }, 300);
};
...
var $resetPw = document.querySelector('#pw-reset-new-pw');
...
$signupCreateBtn.onclick = function () {
  // email이 중복되지 않으면
  _animation__WEBPACK_IMPORTED_MODULE_0__["movePage"]($signupPage, $loginPage); // email이 중복되면 showEmailErrorMsg(); 
};

$signUpUserName.onblur = function (_ref) {
...
$signUpHintAnswer.onblur = function (_ref6) {
...
$optionsContainer.onclick = function (_ref7) {
...
$signupPw.onblur = function () {
  $pwReq.classList.toggle('active');
};

$resetPw.onfocus = function () {
...
$loginContainer.onmouseleave = function () {
  var $currentPage = document.querySelector('div.fade-in');
  if (!$currentPage || $currentPage.id === 'login') return;
  var $iconBackBtn = document.querySelector('.login-container > div[class*="-page"].fade-in > i');
...
$loginContainer.onclick = function (_ref8) {
...
$forgotPwEmail.onblur = function (_ref9) {
...
$pwHintInput.onblur = function (_ref10) {
...
$pwResetNewPw.addEventListener('blur', function (_ref11) {
  var target = _ref11.target;
  _validation__WEBPACK_IMPORTED_MODULE_1__["checkPw"](target);
  _validation__WEBPACK_IMPORTED_MODULE_1__["enableCreateAccount"]();
});
$pwResetNewPw.addEventListener('keyup', function (_ref12) {
  var target = _ref12.target;
  _validation__WEBPACK_IMPORTED_MODULE_1__["checkPwCondition"](target);
}); // pw-reset-page에서 password가 일치(password-confirm)하는지 확인

$pwResetNewPwConfirm.onblur = function (_ref13) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetHint", function() { return resetHint; });
...
var resetBtns = function resetBtns() {
  _toConsumableArray($startPageBtns).forEach(function ($btn) {
    $btn.disabled = true;
  });
};
...
var resetMsg = function resetMsg() {
  var $msgs = document.querySelectorAll('.msg-show');

  _toConsumableArray($msgs).forEach(function ($msg) {
    $msg.classList.remove('msg-show');
  });
};

var resetErrorBg = function resetErrorBg() {
  var errorBg = document.querySelectorAll('.warning');
...
/*!******************************!*\
  !*** ./src/js/validation.js ***!
  \******************************/
/*! exports provided: checkLengthZero, checkEmail, checkPw, checkPwCondition, checkPwConditionResult, checkConfirmPw, enableCreateAccount, enableNextBtn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
// validation.js
var checkLengthZero = function checkLengthZero($target) {
  var input = $target.value.trim();
  var $lengthMsg = $target.nextElementSibling;
...
var checkEmail = function checkEmail($target) {
  ...
  var $lengthMsg = $target.nextElementSibling;
  var $formMsg = $lengthMsg.nextElementSibling;
...
var checkPwCondition = function checkPwCondition($target) {
  ...
  var numExp = /[0-9]/;
  var upperExp = /[A-Z]/;
  var specialExp = /[^A-Za-z0-9]/gi;
  var $form = $target.parentNode;
  var $pwReqLength = $form.querySelector('ul > li[class*="-length"');
  var $pwReqNumber = $form.querySelector('ul > li[class*="-number"');
  var $pwReqUpper = $form.querySelector('ul > li[class*="-upper"');
  var $pwReqSpecial = $form.querySelector('ul > li[class*="-special"'); // const $pwReqNumber = document.querySelector('.pw-req > .pw-req-number');
...
var checkPwConditionResult = function checkPwConditionResult(pw) {
  var numExp = /[0-9]/;
  var upperExp = /[A-Z]/;
  var specialExp = /[^A-Za-z0-9]/gi;
...
var checkPw = function checkPw($target) {
  var pw = $target.value.trim();
  var $lengthMsg = $target.nextElementSibling;
  var $formMsg = $lengthMsg.nextElementSibling;
...
var checkConfirmPw = function checkConfirmPw($pw, $confirmPw) {
  var pw = $pw.value.trim();
  var confirmPw = $confirmPw.value.trim();
  var $lengthMsg = $confirmPw.nextElementSibling;
  var $formMsg = $lengthMsg.nextElementSibling;
...
var enableCreateAccount = function enableCreateAccount() {
  var $warnings = document.querySelectorAll('.signup-form input.warning');
